...
//
//        IDTableColumn.setCellValueFactory(new PropertyValueFactory<Person, String>("Name"));
//        IDTableColumn.setCellValueFactory(new PropertyValueFactory<Person, String>("ID"));
//        IDTableColumn.setCellValueFactory(new PropertyValueFactory<Person, String>("Salary"));
//
//
//    }
//
...
//        panelDataFrame.setVisible(true);
//    }
//
...
//    }
//
////    todo: menampilkan record dari database ke dalam table
//
...
//        private int id;
//
//        public Person(String name, int salary, int id) {
//            this.name = name;
//            Salary = salary;
//            this.id = id;
//        }
